...
func testHello(ctx context.Context, _val interface{}, _os *codec.Buffer, _is *codec.Reader, withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	var SReq string
...
func (_obj *Hello) Dispatch(ctx context.Context, _val interface{}, req *requestf.RequestPacket, resp *requestf.ResponsePacket, withContext bool) (err error) {
	...
	case "testHello":
		err := testHello(ctx, _val, _os, _is, withContext)
		if err != nil {
			return err
		}
